...
def setup_cfg(args):
    ...
    register_coco_instances("bandera_test", metadata, "test.json", "test_images")
    cfg = get_cfg()
...
if __name__ == "__main__":
    ...
    if args.input:
        ...
        for vis_frame, annotations in tqdm.tqdm(demo.run_on_video(video, args.frame_skip, visualization=True), total=num_frames / args.frame_skip):
